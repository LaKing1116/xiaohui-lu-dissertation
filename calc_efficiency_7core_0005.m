...
%This code is used to calculate coupling efficiency and crosstalk for a PL with 7 SMFs and a capillary delta of -0.5%.
...
capillary_delta = -0.005;

% P.n_background = 1.44; % Background refractive index  F doped silica,capillary
P.n_background = sqrt((-n_clad^2)/(2*capillary_delta-1)); % Background refractive index = 1.4368; F doped silica,capillary
