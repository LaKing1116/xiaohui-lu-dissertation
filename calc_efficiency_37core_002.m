...
%This code is used to calculate coupling efficiency and crosstalk for a PL with 37 SMFs and a capillary delta of -2%.
...
taper_ratio = [5:0.1:17];  %can run these number (18 19) 
