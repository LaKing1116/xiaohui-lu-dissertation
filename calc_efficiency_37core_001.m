...
%This code is used to calculate coupling efficiency and crosstalk for a PL with 37 SMFs and a capillary delta of -1%.
...
taper_ratio = [5:0.1:17];  %cannot run these number (18 19) 
...
P = findModes(P,37);  %MMF has 51 modes
...
xlabel('MMF Mode');
ylabel('SMF Mode');
title('Coupling matrix for PL with 37 SMFs');
%% Coupling Efficiency
