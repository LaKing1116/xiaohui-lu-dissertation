...
% This code is for evolution of modes throughout the tapered transition of the photonic lantern with 7 SMFs.
...
taper_ratio = [1 2 4 6 8 10 12 14];%%[2 4 6 8 10 12 14]
...
P = findModes(P,51);  %MMF has 51 modes but  SMF only find 12 guided modes when taper ratio = 14 
...
% Divide 240μm(original outer diameter) by each element in a taper_ratio matrix
B = 240 ./ taper_ratio;
figure()
...
title('Evolution of modes for PL with 7 SMFs and -1% capillary delta')  % Sets the title for the entire plot
% % Set the limits of the x and y axes
% xlim([20 120])  % Replace xmin and xmax with your actual limits
% ylim([1.43 1.445])  % Replace ymin and ymax with your actual limits
