...
%This code is used to calculate coupling efficiency and crosstalk for a PL with 7 SMFs and a capillary delta of -1.5%.
...
P.n_background = sqrt((-n_clad^2)/(2*capillary_delta-1)); % n_Background refractive index = 1.4228;F doped silica,capillary
