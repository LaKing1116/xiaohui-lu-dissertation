...
% This code is for evolution of modes throughout the tapered transition of the photonic lantern with 37 SMFs.
...
taper_ratio = 2 4 8 16 20 32]; %[2 4 8 16 20 32]mode error  [2 5 8 11 14 17]yes
...
% Divide original outer diameter 7*80(μm) by each element in a taper_ratio matrix
B = 560 ./ taper_ratio;
figure()
...
title('Evolution of modes for PL with 37 SMFs and -1% capillary delta')  % Sets the title for the entire plot
...
% % cladding 3-1 ()
n((X + 3*80e-6).^2 + (Y + 0e-6).^2 < 40e-6^2) = n_cladding;

% % cladding 3-2 ()
n((X - 3*80e-6).^2 + (Y + 0e-6).^2 < 40e-6^2) = n_cladding;

% % cladding 3-3 ()
n((X + 3*40e-6).^2 + (Y + 3*3^0.5*40e-6).^2 < 40e-6^2) = n_cladding;
...
% % cladding 3-7 ()
n((X + 40e-6).^2 + (Y + 3*3^0.5*40e-6).^2 < 40e-6^2) = n_cladding;
...
% % cladding 3-11 ()
n((X + 4*40e-6).^2 + (Y + 2*3^0.5*40e-6).^2 < 40e-6^2) = n_cladding;
...
% % cladding 3-15 ()
n((X + 5*40e-6).^2 + (Y + 3^0.5*40e-6).^2 < 40e-6^2) = n_cladding;
...
% % core 3-1 ()
n((X + 3*80e-6).^2 + (Y + 0e-6).^2 < 2.5e-6^2) = n_core;

% % core 3-2 ()
n((X - 3*80e-6).^2 + (Y + 0e-6).^2 < 2.5e-6^2) = n_core;

% % core 3-3 ()
n((X + 3*40e-6).^2 + (Y + 3*3^0.5*40e-6).^2 < 2.5e-6^2) = n_core;
...
% % core 3-7 ()
n((X + 40e-6).^2 + (Y + 3*3^0.5*40e-6).^2 < 2.5e-6^2) = n_core;
...
% % core 3-11 ()
n((X + 4*40e-6).^2 + (Y + 2*3^0.5*40e-6).^2 < 2.5e-6^2) = n_core;
...
% % core 3-15 ()
n((X + 5*40e-6).^2 + (Y + 3^0.5*40e-6).^2 < 2.5e-6^2) = n_core;
