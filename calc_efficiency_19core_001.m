...
%This code is used to calculate coupling efficiency and crosstalk for a PL with 19 SMFs and a capillary delta of -1%.
...
% xlabel('MMF Mode');
% ylabel('SMF Mode');
% title('Coupling matrix for PL with 19 SMFs');
%% Coupling Efficiency
